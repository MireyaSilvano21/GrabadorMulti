package mx.edu.utez.grabador.viewmodel
...
import mx.edu.utez.grabador.data.dao.AppDatabase
import mx.edu.utez.grabador.data.repository.MediaRepository
import java.io.File

class MediaViewModel {
    // --- 7. MediaViewModel —
    class MediaViewModel(application: Application, private val repository: MediaRepository) :
...
// Ahora que tenemos una Uri, podemos usar la lógica existente
        ...
        private fun getMetadataFromUri(
